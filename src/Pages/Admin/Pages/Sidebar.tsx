...
//   const handleLogout = () => {
//     dispatch(clearUser()); // remove data from Redux
//     localStorage.removeItem("activeSection"); // optional: clear saved section
//     // optionally redirect to login page
//     window.location.href = "/signin";
//   };
//   const menuItems = [
//     { id: "dashboard", icon: LayoutDashboard, label: "Dashboard" },
//     { id: "AddEstimation", icon: CalendarCheck, label: "AddEstimation" },
