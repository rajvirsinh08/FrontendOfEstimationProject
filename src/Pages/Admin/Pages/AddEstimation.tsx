...
//     // Auto-calc total cost if Hourly mode
//     setFormData((prev) => {
//       const updated = { ...prev, [name]: value };

//       if (
//         updated.costType === "Hourly" &&
//         updated.estimatedHours &&
//         updated.hourlyCost
//       ) {
//         updated.totalCost = (
//           Number(updated.estimatedHours) * Number(updated.hourlyCost)
//         ).toString();
//       }
...
//               {/* Auto-calculated totalCost display */}
